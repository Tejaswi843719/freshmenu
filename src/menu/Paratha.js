...
const Paratha = () => {
    const { state: { paratha }, handleUpdate } = useContext(CartContext)
    return (
        <div className="row mt-4 ">
            {paratha.map(({ img, name, type, rates, price }, index) => (
                <div className="col-lg-4 col-md-5 col-sm-12 mb-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="h5 d-flex justify-content-between">
                                <div>₹{price}</div>
                                <button onClick={(e) => handleUpdate(e, index)} id="paratha" className="btn btn-warning btn-center btn-lg"><i className="fa fa-shopping-cart"></i>Order</button>
                            </div>
                        </div>
                    </div>
                </div>
