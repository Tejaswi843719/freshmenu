...
const Sandwich = () => {
    const { state: { sandwich }, handleUpdate } = useContext(CartContext)
    return (
                ...
                <div className="col-lg-4 col-md-5 col-sm-12 mb-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="h5 d-flex justify-content-between">
                                <div>₹{price}</div>
                                <button onClick={(e) => handleUpdate(e, index)} id="sandwich" className="btn btn-warning btn-center btn-lg"><i className="fa fa-shopping-cart"></i>Order</button>
                            </div>
                        </div>
                    </div>
                </div>
